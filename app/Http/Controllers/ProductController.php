...
class ProductController extends BaseController
{
    ...
    public function store(Request $request)
    {
        ...
        $product_featured = Input::get('featured');
        ...
        $product_id = DB::table('products')->insertGetId(
            ['name' => $product_name, 'category' => $product_category, 'subcategory' => $product_subcategory, 'price' => $product_price, 'offer_price' => $product_offer_price, 'status' => $product_status, 'featured' => $product_featured, 'description' => $product_description]
        );
    ...
    public function update($id, Request $request)
    {
        ...
        DB::table('products')->where('id', $id)->update(
            ['name' => $product_name, 'category' => $product_category, 'subcategory' => $product_subcategory, 'price' => $product_price, 'offer_price' => $product_offer_price, 'featured' => $product_featured, 'status' => $product_status, 'description' => $product_description]
        );
