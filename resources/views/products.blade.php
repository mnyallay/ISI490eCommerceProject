    ...
    <div class="row-fluid">
        <div class="span12">
            <div class="grid simple ">
                ...
                <div class="grid-body ">
                    <a href="/administrator/create_product"> <button class="btn btn-primary"  style="margin-bottom:20px" id="test2">Add Product</button></a>
                    ...
                    <table class="table" id="example3" >
                        ...
                        <tr class="odd gradeX">
                            ...
                            @else
                                <td>Active</td>
                            @endif
                            <td><a href="/administrator/edit_product/{{$product->id}}"> <button type="button" class="btn btn-primary btn-sm">Edit</button></a></td>
