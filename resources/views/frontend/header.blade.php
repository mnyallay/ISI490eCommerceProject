                ...
                <div class="col-sm-6 ">
                    <div class="contactinfo">
                        <ul class="nav nav-pills">
                            <li><a href=""><i class="fa fa-phone"></i> 929 255 9044</a></li>
                            <li><a href=""><i class="fa fa-envelope"></i> alhaji.nyallay@cix.csi.cuny.edu</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-6">
                    {{--<div class="social-icons pull-right">--}}
                        {{--<ul class="nav navbar-nav">--}}
                            ...
                            {{--<li><a href="{{$settings->linked_in}}"><i class="fa fa-linkedin"></i></a></li>--}}
